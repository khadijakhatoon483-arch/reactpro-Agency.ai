...
const Navbar = ({theme, setTheme}) => {
  ...
  return (
    ...
    sticky top-0 z-20 backdrop-blur-xl font-medium bg-white/50 dark:bg-gray-900/70'>
      ...
      max-sm:fixed max-sm:top-0 max-sm:bottom-0 max-sm:right-0 max-sm:min-h-screen 
...
<img src={assets.close_icon} alt="" className='w-5 absolute right-4 top-4 sm:hidden' 
 onClick={()=> setSidebarOpen(false)}/>
      ...
      <div className='flex item-center gap-2 sm:gap-4'>
        ...
        <img  src= { theme === 'dark' ? AuthenticatorAssertionResponse.menu_icon_dark : assets.menu_icon}
        ...
        cursor-pointer hover:scale-105 transition-all'> Connect <img src={assets.arrow_icon} width={14} alt=""/>
