  ...
  return (
    ...
    xl:px-40 text-center w-full overflow-hidden text-gray-700 dark:text-white'>
     ...
     className='inline-flex items-center gap-2 border border-gray-300 p-1.5 pr-4 rounded-full'>
       ...
       <p className='text-xs font-medium'> Trusted by10K people</p>
...
<motion.p 
 initial={{opacity:0, y:30}}
       ...
       sm:max-w-lg pb-3 '>
    Crating meaningful connections and turning big ideas into interactive digital experiences.</motion.p>
   <motion.div 
  ...
  <img
    src={assets.bgImage1}
    alt=""
    className="absolute -top-20 -right-20 sm:-top-24 sm:-right-24 -z-10 dark:hidden"
  />
</motion.div>
    </div>    
