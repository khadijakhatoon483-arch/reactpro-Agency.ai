...
const Footer = ({theme}) => {
  return (
    ...
    sm:px-10 lg:px-24 xl:px-40 border border-gray-100'>
 ...
 <div className='flex justify-between lg:items-center max-lg:flex-col gap-10'>
    ...
    className='space-y-5 text-sm text-gray-700 dark:text-gray-400'>
        ...
        <p className='max-w-md'>
            From stratagy to execute, we craft digital solutions that move your bussiness forward</p>
    ...
    className='text-gray-600 dark:text-gray-400'>
        ...
        <p className='text-sm mt-2 mb-6'>
            The latest news, articals, and resources, sent to your inbox weekly.</p>
...
<hr className='border-gray-300 dark:border-gray-600 my-6' />
 ...
 className='pb-6 text-sm text-gray-500 flex justify-center sm:justify-between gap-4 flex-warp'>
  ...
  <p>Copyright 2025 @ GreateStack -All Right Reserved.</p>
